...
class ServiceRunner:
    ...
    def run(self) -> int:
        ...
        _emit({
            ...
            "activity_saturate_rps": self.detector_cfg.activity_saturate_rps,
            ...
            "subgraph_saturate_rps": self.detector_cfg.subgraph_saturate_rps,
            ...
            "buy_fak_retry_enabled": self.buy_cfg.fak_retry_enabled,
